...
module['exports'] = {
    ...
    run: async(_0xf396x7, _0xf396x8) => {
        ...
        const _0xf396x3 = _0xf396x8['options']['getString']('port');
            ...
            const _0xf396x11 = new MessageEmbed()['setColor']('RANDOM')['setTitle'](version)['setDescription']('WAITING...')['setImage']('https://i.pinimg.com/originals/86/c0/25/86c025297e8b557da4522d2b48cd1757.gif')['setFooter']('\xA9 Developer: Jack zeus', img)['setTimestamp']();
            _0xf396x8['reply']({
                embeds: [_0xf396x11]
            })['then']((_0xf396x12) => {
                setTimeout(function () {
