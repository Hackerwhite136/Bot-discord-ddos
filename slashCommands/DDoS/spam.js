    ...
    run: async(_0xf396x7, _0xf396x8) => {
        ...
        if (_0xf396x9 === 'SMS-V1') {
            ...
            const _0xf396x10 = new MessageEmbed()['setColor']('RANDOM')['setTitle'](version)['addFields']({
                ...
                name: '**`👑 Admin:`**',
                value: `${' [ đặng quang huy ] '}`,
                inline: true
            })['setImage'](randomgif)['setFooter']('\xA9 Developer: Jack zeus', img)['setTimestamp']();
            const _0xf396x11 = new MessageEmbed()['setColor']('RANDOM')['setTitle'](version)['setDescription']('LOADING...')['setImage']('https://i.pinimg.com/originals/fa/89/38/fa893857327bbc5f67587c9536f27a25.gif')['setFooter']('\xA9 Developer: Jack zeus', img)['setTimestamp']();
            _0xf396x8['reply']({
                embeds: [_0xf396x11]
            })['then']((_0xf396x12) => {
                setTimeout(function () {
